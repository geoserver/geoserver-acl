...
Issuing a pull request requires that you [fork the GeoServer ACL git repository](https://github.com/geoserver/geoserver-acl) into your own account.
...
1. **Add copyright headers:**
   ...
   * When adding content from another organisation maintain copyright history and original license. Only add Open Source Geospatial Foundation if you have made modifications to the file for GeoServer ACL:
