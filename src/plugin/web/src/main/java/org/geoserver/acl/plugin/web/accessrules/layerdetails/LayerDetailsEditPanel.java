 ...
 *   <li>If the {@link MutableLayerDetails#getLayerType() layerType} is {@link LayerType#LAYERGROUP
 *       LAYERGROUP}, then {@link MutableLayerDetails#getDefaultStyle DefaultStyle}, {@link
 *       MutableLayerDetails#getAllowedStyles AllowedStyles}, {@link
 *       MutableLayerDetails#getCqlFilterRead CqlFilterRead}, and {@link
 *       MutableLayerDetails#getCqlFilterWrite CqlFilterWrite} are not editable nor visible.
 *   <li>{@link MutableLayerDetails#getCatalogMode() CatalogMode} is not shown in this panel, it's
 *       assigned the value given at {@link DataAccessRuleEditPanel}, which pivots to {@link
 *       LayerDetails#getCatalogMode() LayerDetails} and {@link RuleLimits#getCatalogMode()
 *       RuleLimits} as appropriate.
 * </ul>
 *
...
public class LayerDetailsEditPanel extends FormComponentPanel<MutableLayerDetails> {
    ...
    /**
     * container for {@link #defaultStyle} and {@link #allowedStyles}, made invisible if the layer
     * type is layergroup
     */
    ...
    /**
     * container for{@link #area}, {@link #cqlFilterRead} and {@link #cqlFilterWrite}, makes cql
     * filters invisible if the layer type is not of type vector
     */
