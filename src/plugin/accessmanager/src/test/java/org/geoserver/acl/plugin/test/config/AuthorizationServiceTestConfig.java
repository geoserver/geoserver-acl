...
/**
 * Loaded from {@literal src/test/resources/applicationContext-test.xml}, provides a memory
 * implementation of {@link RuleRepository} and {@link AdminRuleRepository}, and imports the
 * configurations to load {@link RuleAdminService}, {@link AdminRuleAdminService}, and {@link
 * AuthorizationService}.
 *
 * <p>As a consequence, {@link AuthorizationService} runs in-process and uses rule and adminrule
 * services backed by heap storage.
 */
@Configuration
@Import({
...
public class AuthorizationServiceTestConfig {
    ...
    @Bean
    AccessManagerConfigProvider testAclAccessManagerConfigProvider() {
        AccessManagerConfig configDefaults = new AccessManagerConfig();
