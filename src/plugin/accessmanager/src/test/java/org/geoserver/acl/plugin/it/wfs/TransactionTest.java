 ...
 * </pre>
 */
public class TransactionTest extends AbstractAclWFSIntegrationTest {
    ...
    public void testInsert() throws Exception {
        ...
        support.addRule(ALLOW, null, "ROLE_IAU", null, null, "iau", "MarsPoi", 1);
    ...
    public void testInsertWithCqlWriteRule() throws Exception {
        Rule allowRule = support.addRule(ALLOW, null, "ROLE_IAU", null, null, "iau", "MarsPoi", 1);
     ...
     * {@link ACLResourceAccessManager#buildVectorAccessLimits()} correctly creates the
     * {@link VectorAccessLimits}, but {@link SecuredFeatureLocking#modifyFeatures(org.geotools.api.feature.type.Name[], Object[], org.geotools.api.filter.Filter)}
     * and {@link SecuredFeatureStore#modifyFeatures(org.geotools.api.feature.type.Name[], Object[], org.geotools.api.filter.Filter)}
     * do not validate the names/values arrays comply with the {@link VectorAccessLimits#getWriteFilter()}
     */
    @Test
