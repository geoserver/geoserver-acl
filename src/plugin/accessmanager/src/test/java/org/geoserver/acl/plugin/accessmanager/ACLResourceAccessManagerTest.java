...
public class ACLResourceAccessManagerTest extends AclBaseTest {
    ...
    /**
     * Catalog is a {@link SecureCatalogImpl}, and the base test sets up a rule where everyone can
     * access the WMS service, but not any other service. Test the catalog hides layers for a WFS
     * request, but are visible to WMS requests
     */
    @Test
