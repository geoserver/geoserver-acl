...
public abstract class AbstractAclWFSIntegrationTest extends WFSTestSupport {
    ...
    /**
     * Avoids a several seconds (42 seconds in my case) startup penalty at {@link WFSXmlUtils#initRequestParser()} call to {@link InetAddress#getHostName()} from:
     * <pre>
