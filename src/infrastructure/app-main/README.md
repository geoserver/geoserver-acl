...
The OpenAPI 3 specification is available at [geoserver-acl-web-api-spec-v1.yaml](../web-api/spec/src/main/resources/geoserver-acl-web-api-spec-v1.yaml).
...
will create a single-jar executable at `target/gs-acl-app-<version>-bin.jar`.
