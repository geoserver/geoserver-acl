...
public class Geom {
    ...
    public Geom wkt(@Nullable String wkt) {
        this.wkt = wkt;
        return this;
    }
    ...
    public Geom wkb(@Nullable byte[] wkb) {
        this.wkb = wkb;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Geom geom = (Geom) o;
        return Objects.equals(this.wkt, geom.wkt) && Arrays.equals(this.wkb, geom.wkb);
    }

    @Override
    public int hashCode() {
        return Objects.hash(wkt, Arrays.hashCode(wkb));
    }

    @Override
    public String toString() {
        StringBuilder sb = new StringBuilder();
        sb.append("class Geom {\n");
