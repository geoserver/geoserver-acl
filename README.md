[![SonarCloud](https://sonarcloud.io/images/project_badges/sonarcloud-white.svg)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)

[![Reliability Rating](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=reliability_rating)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Maintainability Rating](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=sqale_rating)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Security Rating](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=security_rating)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Bugs](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=bugs)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=vulnerabilities)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Code Smells](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=code_smells)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Technical Debt](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=sqale_index)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)

[![Lines of Code](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=ncloc)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Coverage](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=coverage)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=geoserver_geoserver-acl&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=geoserver_geoserver-acl)
[![build](https://github.com/geoserver/geoserver-acl/actions/workflows/build.yaml/badge.svg)](https://github.com/geoserver/geoserver-acl/actions/workflows/build.yaml)
